      ...
      if(isset($_POST["login"])){
           if(empty($_POST["username"]) || empty($_POST["password"])){
                        ...
                        "SELECT
                            ...
                            FROM usuarios u                            
                                ...
                                LEFT JOIN roles r ON r.id_rol = u.rol
                                    ...
                                    WHERE u.correo=:correo AND u.passw=:passw AND u.id_estado = 1");
                ...
                if($count > 0){
                    ...
                    $_SESSION["id_rol"]      = $empresa["rol"];
                    $_SESSION["id_usuario"]  = $empresa["id_usuario"];
                    $_SESSION["nombre_rol"]  = $empresa["nombre_rol"];                
                        ...
                        <form role="form" method="post">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="E-mail" name="username" value="crespin@outlook.es" autofocus>
                                </div>
                                <div class="form-group">
                                ...
                                <button type="submit" name="login" class="btn btn-lg btn-success btn-block">Iniciar Sesión</button>
                            </fieldset>
                        </form>
                    </div>
                </div>
